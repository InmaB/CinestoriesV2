...
export default function Pelis() {
  ...
  // Carga los géneros al montar el componente con el tipo movie
  useEffect(() => {
    dispatch(getGenres({ type: "movie" }));
  }, [])

  // Carga las películas cuando se hayan cargado los géneros con el tipo movie
  useEffect(() => {
    if (genresLoaded) {
  ...
  // Maneja la selección de un género cuando se pulse el botón de tipo movie
  ...
  // Muestra todas las películas que se realiza por defencto al acceder a la página "Pelis"
